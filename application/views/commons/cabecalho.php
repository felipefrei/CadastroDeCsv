...
<html lang="pt_BR">
  <head>
    ...
    <meta name="author" content="Felipe Frei">
    <link rel="icon" href="<?=base_url('assets/images/logo_null_HrAUUQ.ico')?>">
...
<script src="<?=base_url('assets/js/jquery/jquery.blockUI.js')?>"></script>
